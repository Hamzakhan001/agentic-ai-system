...
Production-style multi-agent backend for document review and legal workflow automation, built with FastAPI, LangGraph, Postgres, Pinecone, Phoenix, and configurable LLM providers.

This system ingests documents, retrieves relevant evidence, orchestrates specialised agents for review tasks, persists review runs, supports human approval and revision, and provides observability and offline benchmarking for production-style evaluation.
...
Overview
This backend is designed to go beyond a simple chatbot or notebook prototype. It focuses on the system components needed for real-world GenAI applications:

multi-agent orchestration with LangGraph
retrieval over ingested documents
external research/tool integration
Postgres-backed run persistence
API-based human review workflow
...
ollama serve
Why This Project
This project was built to explore what a more realistic GenAI backend looks like beyond notebook workflows and lightweight demos.
